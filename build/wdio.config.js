...
var referenceDirectory = path.join(process.cwd(), 'test/screenshots/' + theme + '/reference')
var screenshotDirectory = path.join(process.cwd(), 'test/screenshots/' + theme + '/screen')
var diffDirectory = path.join(process.cwd(), 'test/screenshots/' + theme + '/diff')
...
exports.config = {
  ...
  screenshotPath: '../test/screenshots/' + theme + '/error',
  //
